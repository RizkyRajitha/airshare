  ...
  render() {
    return (
      <div className="container">
        ...
        <p>
          AIRSHARE takes no responsibility for the file you store, and will not
          guarantee to safeguard your files. Although we take our maximum effort
          to secure your user data and your files. any data breach could leak
          your files, so we highly recommend you not to store any sensitive
          information. AIRSHARE will permanently ban users who store illegal
          files in our service, including adult content, any conspiracy
          materials, etc.
        </p>
