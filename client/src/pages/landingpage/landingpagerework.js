...
class Landingpage extends Component {
  ...
  render() {
    ...
    >
      ...
      <path fill="url(#a)" d="M28 39a5 5 0 100 10 5 5 0 100-10z"></path>
      <linearGradient
        id="b"
        x1="32"
        x2="32"
      ...
      <path
        fill="url(#b)"
        d="M49 11c-6.617 0-12 5.383-12 12 0 2.949 1.074 5.649 2.845 7.741l-6.234 6.234C32.071 35.742 30.122 35 28 35s-4.071.742-5.611 1.975l-5.077-5.077A7.953 7.953 0 0019 27c0-4.411-3.589-8-8-8s-8 3.589-8 8 3.589 8 8 8a7.948 7.948 0 004.897-1.688l5.077 5.077A8.953 8.953 0 0019 44c0 4.963 4.037 9 9 9s9-4.037 9-9a8.948 8.948 0 00-1.975-5.611l6.234-6.234A11.944 11.944 0 0049 35c6.617 0 12-5.383 12-12s-5.383-12-12-12zM11 33c-3.309 0-6-2.691-6-6s2.691-6 6-6 6 2.691 6 6-2.691 6-6 6zm17 18c-3.859 0-7-3.141-7-7s3.141-7 7-7 7 3.141 7 7-3.141 7-7 7zm21-18c-5.514 0-10-4.486-10-10s4.486-10 10-10 10 4.486 10 10-4.486 10-10 10z"
      ></path>
      <linearGradient
        id="c"
        x1="49"
      ...
      <path
        fill="url(#c)"
        d="M49 15c-4.411 0-8 3.589-8 8s3.589 8 8 8 8-3.589 8-8-3.589-8-8-8zm0 14c-3.309 0-6-2.691-6-6s2.691-6 6-6 6 2.691 6 6-2.691 6-6 6z"
      ></path>
    </svg>
              ...
              <div className="hero-inner">
                ...
                <div className="hero-form newsletter-form field field-grouped is-revealing">
                  <div className="control control-expanded">
                    <input className="input" name="email" placeholder="Your best email…" type="email" />
                  </div>
                  <div className="control">
                    <a className="button button-primary button-block button-shadow" href="#">Get early access</a>
                  </div>
                </div>
                <div className="hero-browser">
                  <div className="bubble-3 is-revealing">
                    <svg width={427} height={286} viewBox="0 0 427 286" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                      ...
                      <g fill="none" fillRule="evenodd" shape-rendering="crispEdges" >
                  ...
                  <div className="bubble-1 is-revealing">
                    <svg width={61} height={52} viewBox="0 0 61 52" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                      ...
                      <g fill="none" fillRule="evenodd"  shape-rendering="crispEdges">
                        <mask id="bubble-1-b" fill="#fff"  shape-rendering="crispEdges" >
                          <use xlinkHref="#bubble-1-a" />
                        </mask>
                        <use fill="#FF6D8B" xlinkHref="#bubble-1-a" />
                        <path d="M2 43.992c17.673 0 28.05 17.673 28.05 0S19.674 0 2 0c-17.673 0-32 14.327-32 32 0 17.673 14.327 11.992 32 11.992z" fill="#FF4F73" mask="url(#bubble-1-b)"  shape-rendering="crispEdges" />
                        <path d="M74 30.992c17.673 0 28.05 17.673 28.05 0S91.674-13 74-13C56.327-13 42 1.327 42 19c0 17.673 14.327 11.992 32 11.992z" fillOpacity=".8" fill="#FFA3B5" mask="url(#bubble-1-b)"  shape-rendering="crispEdges" />
                      </g>
                    </svg>
                  </div>
                ...
                <div className="features-wrap">
                  <div className="feature is-revealing">
                    <div className="feature-inner">
                      ...
                      <p className="text-sm">Where text is visible, people tend to focus on the textual content rather than upon overall presentation.</p>
                    </div>
                  </div>
                  <div className="feature is-revealing">
                    <div className="feature-inner">
        ...
        <footer className="site-footer text-light">
          <div className="container">
            <div className="site-footer-inner">
              ...
              <div className="footer-copyright">© 2018 Ava, all rights reserved</div>
            </div>
          </div>
        </footer>
      </div>
